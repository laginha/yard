...
is_related_manager_object  = lambda x: "django.db.models.fields.related.RelatedManager" in str(type(x))
is_generic_related_manager = lambda x: "django.contrib.contenttypes.generic.GenericRelatedObjectManager" in str(type(x))
is_related_manager         = lambda x: is_many_related_manager(x) or is_related_manager_object(x) or is_generic_related_manager(x)
