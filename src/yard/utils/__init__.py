...
is_manyrelatedmanager = lambda x: "django.db.models.fields.related.ManyRelatedManager" in str(type(x))
is_relatedmanager     = lambda x: "django.db.models.fields.related.RelatedManager" in str(type(x))
is_genericrelatedobjectmanager     = lambda x: "django.contrib.contenttypes.generic.GenericRelatedObjectManager" in str(type(x))
